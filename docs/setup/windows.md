...
腾讯云 Windows LogListener 仅支持官方列出的 64 位 Windows Server，Windows 10/11 本地开发机不属于支持范围。本地测试日志使用项目的 Python CLS SDK 上传；生产服务器的 LogListener、机器组和 JSON 文件采集步骤见[CLS SDK 与 LogListener 接入教程](../tutorials/cls-ingestion.md)。
