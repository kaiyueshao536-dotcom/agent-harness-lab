...
from .protocols import (
    AiopsDiagnosticRunner,
    DocumentIndexTaskScheduler,
    DocumentVectorStoreProvider,
    ...
    *,
    ...
    app.include_router(
        build_operations_router(
            runtime_dependency_payload=lambda request: _runtime_dependency_payload(request),
            configuration_check_payload=lambda request: _configuration_check_payload(request),
            mcp_client_resolver=lambda request: _mcp_client(request),
        )
    )
